...
import com.balsam.system.common.constant.CacheConstants;
import com.balsam.system.common.constant.Constants;
import com.balsam.system.common.constant.UserConstants;
import com.balsam.system.common.core.domain.model.LoginUser;
import com.balsam.system.common.core.redis.RedisCache;
import com.balsam.system.common.exception.ServiceException;
import com.balsam.system.common.exception.user.BlackListException;
import com.balsam.system.common.exception.user.CaptchaException;
import com.balsam.system.common.exception.user.CaptchaExpireException;
import com.balsam.system.common.exception.user.UserNotExistsException;
import com.balsam.system.common.exception.user.UserPasswordNotMatchException;
import com.balsam.system.common.utils.DateUtils;
import com.balsam.system.common.utils.MessageUtils;
...
public class SysLoginService
{
    ...
    public SsoLoginDTO ssologin(LoginBody loginBody) {
        AjaxResult ajax = AjaxResult.success();

        String username = loginBody.getUsername();
        SsoLoginDTO ssoLoginDTO=new SsoLoginDTO();
        ssoLoginDTO.setType("sjjc");

        SysUser user = userService.selectUserByUserName(username);

        if (ObjectUtil.isNull(user)){
            ajax.put(Constants.TOKEN, null);
            ssoLoginDTO.setAjaxResult(ajax);
